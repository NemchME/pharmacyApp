...
public class OrderMenu implements Menu {
    ...
    public OrderMenu() {
        ...
        descriptionsMap.put("1", "Получить все заказы");
        descriptionsMap.put("2", "Сохранить заказ");
        descriptionsMap.put("3", "Найти заказ");
        descriptionsMap.put("4", "Обновить заказ");
        descriptionsMap.put("5", "Удалить заказ");
