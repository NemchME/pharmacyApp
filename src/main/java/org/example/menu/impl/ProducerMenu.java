...
import org.example.command.producer.*;
...
public class ProducerMenu implements Menu {
    ...
    public ProducerMenu() {
        ...
        descriptionsMap.put("1", "Получить всех производителей");
        descriptionsMap.put("2", "Сохранить производителя");
        descriptionsMap.put("3", "Найти производителя");
        descriptionsMap.put("4", "Обновить производителя");
        descriptionsMap.put("5", "Удалить производителя");
